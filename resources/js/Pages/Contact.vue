      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mb-5 mb-lg-0">
            ...
            <p class="text-muted">
              Have a project in mind or want to learn more about our services? Send us a
            ...
            <div class="d-flex align-items-center mb-4">
              ...
              <div>
                ...
                <br />
                <span class="text-muted"> 123 Agency Street, City </span>
              </div>
            </div>
            ...
            <div class="d-flex align-items-center">
              ...
              <div>
                <strong>Email</strong>
                <br />
                <span class="text-muted"> hello@agency.com </span>
              </div>
            </div>
          </div>
